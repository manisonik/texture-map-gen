...
typedef cairo_gl_generic_func_t (__stdcall* cairo_gl_get_proc_addr_func_t)(const char *procname);

typedef struct _cairo_gl_dispatch {
    /* Buffers */
    void (_stdcall *GenBuffers) (GLsizei n, GLuint *buffers);
    void (_stdcall *BindBuffer) (GLenum target, GLuint buffer);
    void (_stdcall *BufferData) (GLenum target, GLsizeiptr size,
			  const GLvoid* data, GLenum usage);
    GLvoid *(_stdcall *MapBuffer) (GLenum target, GLenum access);
    GLboolean (_stdcall *UnmapBuffer) (GLenum target);

    /* Shaders */
    GLuint (_stdcall *CreateShader) (GLenum type);
    void (_stdcall *ShaderSource) (GLuint shader, GLsizei count,
			    const GLchar** string, const GLint* length);
    void (_stdcall *CompileShader) (GLuint shader);
    void (_stdcall *GetShaderiv) (GLuint shader, GLenum pname, GLint *params);
    void (_stdcall *GetShaderInfoLog) (GLuint shader, GLsizei bufSize,
				GLsizei *length, GLchar *infoLog);
    void (_stdcall *DeleteShader) (GLuint shader);

    /* Programs */
    GLuint (_stdcall *CreateProgram) (void);
    void (_stdcall *AttachShader) (GLuint program, GLuint shader);
    void (_stdcall *DeleteProgram) (GLuint program);
    void (_stdcall *LinkProgram) (GLuint program);
    void (_stdcall *UseProgram) (GLuint program);
    void (_stdcall *GetProgramiv) (GLuint program, GLenum pname, GLint *params);
    void (_stdcall *GetProgramInfoLog) (GLuint program, GLsizei bufSize,
				 GLsizei *length, GLchar *infoLog);

    /* Uniforms */
    GLint (_stdcall *GetUniformLocation) (GLuint program, const GLchar* name);
    void (_stdcall *Uniform1f) (GLint location, GLfloat x);
    void (_stdcall *Uniform2f) (GLint location, GLfloat x, GLfloat y);
    void (_stdcall *Uniform3f) (GLint location, GLfloat x, GLfloat y, GLfloat z);
    void (_stdcall *Uniform4f) (GLint location, GLfloat x, GLfloat y, GLfloat z,
			 GLfloat w);
    void (_stdcall *UniformMatrix3fv) (GLint location, GLsizei count,
				GLboolean transpose, const GLfloat *value);
    void (_stdcall *UniformMatrix4fv) (GLint location, GLsizei count,
			      GLboolean transpose, const GLfloat *value);
    void (_stdcall *Uniform1i) (GLint location, GLint x);

    /* Attributes */
    void (_stdcall *BindAttribLocation) (GLuint program, GLuint index,
				const GLchar *name);
    void (_stdcall *VertexAttribPointer) (GLuint index, GLint size, GLenum type,
				 GLboolean normalized, GLsizei stride,
				 const GLvoid *pointer);
    void (_stdcall *EnableVertexAttribArray) (GLuint index);
    void (_stdcall *DisableVertexAttribArray) (GLuint index);

    /* Framebuffer objects */
    void (_stdcall *GenFramebuffers) (GLsizei n, GLuint* framebuffers);
    void (_stdcall *BindFramebuffer) (GLenum target, GLuint framebuffer);
    void (_stdcall *FramebufferTexture2D) (GLenum target, GLenum attachment,
				    GLenum textarget, GLuint texture,
				    GLint level);
    GLenum (_stdcall *CheckFramebufferStatus) (GLenum target);
    void (_stdcall *DeleteFramebuffers) (GLsizei n, const GLuint* framebuffers);
    void (_stdcall *GenRenderbuffers) (GLsizei n, GLuint *renderbuffers);
    void (_stdcall *BindRenderbuffer) (GLenum target, GLuint renderbuffer);
    void (_stdcall *RenderbufferStorage) (GLenum target, GLenum internal_format,
				 GLsizei width, GLsizei height);
    void (_stdcall *FramebufferRenderbuffer) (GLenum target, GLenum attachment,
				     GLenum renderbuffer_ttarget, GLuint renderbuffer);
    void (_stdcall *DeleteRenderbuffers) (GLsizei n, GLuint *renderbuffers);
    void (_stdcall *BlitFramebuffer) (GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1,
			     GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1,
			     GLbitfield mask, GLenum filter);
    void (_stdcall *RenderbufferStorageMultisample) (GLenum target, GLsizei samples,
					    GLenum internalformat,
					    GLsizei width, GLsizei height);
    void (_stdcall *FramebufferTexture2DMultisample) (GLenum target, GLenum attachment,
					     GLenum textarget, GLuint texture,
